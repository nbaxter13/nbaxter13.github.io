...
This is the heuristic I decided to use. First I calculated all possible 3-OTU models (`r choose(309,3)` combinations). Then, rather than test all possible 4-OTU models (`r choose(309,4)`), I took the top 100 of those models and sequentially added each of the 309 OTUs to them.  This results approximately `r 309*100` models and saves lots of time.  I then took the 100 best of thoe 4-OTU models and again added each of the 309 OTUs to them.  I repeated this process up to 10-OTU models.
